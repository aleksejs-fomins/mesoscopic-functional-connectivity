...
from lib.stat.stat_lib import mu_std, tolerance_interval_1D
from lib.stat.ml_lib import split_train_test
from lib.signal_lib import zscore
from lib.info_metrics.corr_lib import autocorr_1D
from lib.info_metrics.mar.autoregression1D import AR1D
from lib.info_metrics.npeet_wrapper import entropy, predictive_info
...
def plot_autocorrelation_bychannel(ax, data, fps=1, withFill=True):
    ...
    #ax.legend()
    ax.set_title('autocorr1D average by channel')
...
def plot_entropy_ND_bytime(ax1, ax2, ax3, data, fps=1):
    ...
    # Channel-average 1D entropy and PI as function of time
    ...
    ax2.set_title('Average Total Correlation')
