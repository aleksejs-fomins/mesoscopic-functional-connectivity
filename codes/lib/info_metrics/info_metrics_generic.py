...
def parallel_metric_1d(dataLst, library, methods, settings, parSrc=True, serial=False, nCore=None):
    ...
    # Initialize Sweeper
    ###############################
    sweeper = Sweep1D(dataLst, methods, settings["dim_order"], parSrc=parSrc)
