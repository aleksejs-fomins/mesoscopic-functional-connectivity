...
for network_time_interval = {[1,1.5],[2,3.5],[3.5,6]}
    ...
    % --- save to analysis ---
    analysis.shared_links_go(:,subplot_count) = network_links_shared;
    
    % compute p-value of shared links
    network_links_shared_p_value = NaN([length(network_links_shared),1]);
    
    % --- save to analysis --- 
    analysis.shared_links_p_go(:,subplot_count) = network_links_shared_p_value;
    ...
    % save to analysis
    analysis.shared_links_nogo(:,subplot_count) = network_links_shared;
    ...
    % ---  save to analysis --- 
    analysis.shared_links_p_nogo(:,subplot_count) = network_links_shared_p_value;
...
save('shared_links_stability_analysis.mat','analysis');