function [outdegree,indegree,clustering,eigencentrality,clustering_Hit,clustering_CR]= do_clustering_analysis(perf_def,path_raw,mouse_ID,sessions_IDs)
...
% count for network time interval
for i=1:3
    clustering_Hit{1,i}=cell(1,sessions);
    clustering_CR{1,i}=cell(1,sessions);
end
...
%     end
    ...
    clustering_Hit{1,network_time_interval_count} = network_cluster_GO;
...
%     end
    ...
    clustering_CR{1,network_time_interval_count} = network_cluster_NOGO;
